    ...
    <div class="caja-submenu">
        <div class="submenu">
            ...
            <?php if (isset($_GET['rango'])){ ?>
                <a href="year?rango=<?php echo $_GET['rango']; ?>"><?php echo $_GET['rango']; ?> »</a>
                <strong><?php echo $_GET['marca']; ?></strong>
            <?php }else{ ?>
                <strong><?php if (isset($_GET['marca'])){ echo $_GET['marca'];  } ?></strong>
            <?php } ?>
            <!-- aqui es el total de autos encontrados egun la marca -->
        ...
        <div class="atajo-relevantes">
            ...
            <div class="filtro-precios" style="display: none">
                <?php if (isset($_GET['marca']) && isset($_GET['precio']) && isset($_GET['hasta'])){ ?>
                    <a href="?marca=<?php echo $_GET['marca']; ?>&precio=<?php echo $_GET['precio']; ?>&hasta=<?php echo $_GET['hasta']; ?>&precio_asc">Menor precio</a><br>
                    <a href="?marca=<?php echo $_GET['marca']; ?>&precio=<?php echo $_GET['precio']; ?>&hasta=<?php echo $_GET['hasta']; ?>&precio_desc">Mayor precio</a>
                <?php }elseif(isset($_GET['marca']) && isset($_GET['mas'])){ ?>
                    <a href="?marca=<?php echo $_GET['marca']; ?>&mas=<?php echo $_GET['mas']; ?>&precio_asc">Menor precio</a><br>
                    <a href="?marca=<?php echo $_GET['marca']; ?>&mas=<?php echo $_GET['mas']; ?>&precio_desc">Mayor precio</a>
                <?php }elseif (isset($_GET['marca']) && isset($_GET['precio'])){ ?>
                    <a href="?marca=<?php echo $_GET['marca']; ?>&precio=<?php echo $_GET['precio']; ?>&precio_asc">Menor precio</a><br>
                    <a href="?marca=<?php echo $_GET['marca']; ?>&precio=<?php echo $_GET['precio']; ?>&precio_desc">Mayor precio</a>
                <?php }elseif(isset($_GET['marca']) && isset($_GET['0km'])){ ?>
                    <a href="?marca=<?php echo $_GET['marca']; ?>&0km&precio_asc">Menor precio</a><br>
                    <a href="?marca=<?php echo $_GET['marca']; ?>&0km&precio_desc">Mayor precio</a>
                <?php }else{ ?>
                    <a href="?marca=<?php echo $_GET['marca']; ?>&precio_asc">Menor precio</a><br>
                    <a href="?marca=<?php echo $_GET['marca']; ?>&precio_desc">Mayor precio</a>
                <?php } ?>
            </div>
        </div>
    </div>
    <div class="panel-autos">
        <div class="categorias-navegacion">
            ...
            <div class="contenido-min-320 down-modelo">
                ...
                <?php if (isset($_GET['marca']) && isset($_GET['rango']) && isset($_GET['precio']) && isset($_GET['hasta'])){ ?>
                    @foreach($modelo as $mod)
                        <li class="list-marcas">
                            <a href="selected/modelo?marca=<?php echo $_GET['marca']; ?>&modelo={{ strtolower($mod->modelo) }}&rango=<?php echo $_GET['rango']; ?>&precio=<?php echo $_GET['precio']; ?>&hasta=<?php echo $_GET['hasta']; ?>">
                                {{ strtolower($mod->modelo) }}
                            </a>({{ $mod->total_modelos }})
                        </li>
                    @endforeach
                <?php }elseif (isset($_GET['marca']) && isset($_GET['precio']) && isset($_GET['hasta'])){  ?>
                    @foreach($modelo as $mod)
                    <li class="list-marcas">
                    <a href="selected/modelo?marca=<?php echo $_GET['marca']; ?>&modelo={{ strtolower($mod->modelo) }}&precio=<?php echo $_GET['precio']; ?>&hasta=<?php echo $_GET['hasta']; ?>">
                        {{ strtolower($mod->modelo) }}
                    </a>({{ $mod->total_modelos }})
                    </li>
                    @endforeach
                <?php }elseif (isset($_GET['marca']) && isset($_GET['rango']) && isset($_GET['precio'])){ ?>
                    @foreach($modelo as $mod)
                        <li class="list-marcas">
                            <a href="selected/modelo?marca=<?php echo $_GET['marca']; ?>&modelo={{ strtolower($mod->modelo) }}&rango=<?php echo $_GET['rango']; ?>&precio=<?php echo $_GET['precio']; ?>">
                                {{ strtolower($mod->modelo) }}
                            </a>({{ $mod->total_modelos }})
                        </li>
                    @endforeach
            <?php }elseif (isset($_GET['marca']) && isset($_GET['rango'])){ ?>
                @foreach($modelo as $mod)
                    <li class="list-marcas">
                        <a href="selected/modelo?marca=<?php echo $_GET['marca']; ?>&modelo={{ strtolower($mod->modelo) }}&rango=<?php echo $_GET['rango']; ?>">
                            {{ strtolower($mod->modelo) }}
                        </a>({{ $mod->total_modelos }})
                    </li>
                @endforeach
            <?php }elseif(isset($_GET['marca']) && isset($_GET['mas'])){ ?>
                    @foreach($modelo as $mod)
                        <li class="list-marcas">
                            <a href="selected/modelo?marca=<?php echo $_GET['marca']; ?>&modelo={{ strtolower($mod->modelo) }}&mas=<?php echo $_GET['mas']; ?>">
                                {{ strtolower($mod->modelo) }}
                            </a>({{ $mod->total_modelos }})
                        </li>
                    @endforeach
            <?php }elseif(isset($_GET['marca']) && isset($_GET['precio'])){ ?>
                @foreach($modelo as $mod)
                    <li class="list-marcas">
                        <a href="selected/modelo?marca=<?php echo $_GET['marca']; ?>&modelo={{ strtolower($mod->modelo) }}&precio=<?php echo $_GET['precio']; ?>">
                            {{ strtolower($mod->modelo) }}
                        </a>({{ $mod->total_modelos }})
                    </li>
                    @endforeach
                <?php }elseif(isset($_GET['marca']) && isset($_GET['0km'])){ ?>
                    @foreach($modelo as $mod)
                        <li class="list-marcas">
                        <a href="selected/modelo?marca=<?php echo $_GET['marca']; ?>&modelo={{ strtolower($mod->modelo) }}&0km">
                            {{ strtolower($mod->modelo) }}
                        </a>({{ $mod->total_modelos }})
                    </li>
                    @endforeach
                ...
                @foreach($modelo as $mod)
                    <li class="list-marcas">
                        <a href="selected/modelo?marca=<?php echo $_GET['marca']; ?>&modelo={{ strtolower($mod->modelo) }}">
                            {{ strtolower($mod->modelo) }}
                        </a>({{ $mod->total_modelos }})
                    </li>
            @endforeach
            ...
            <?php if (isset($_GET['marca']) && isset($_GET['rango'])){ ?>
            ...
            <div class="contenido-min-320 down-anio">
                @foreach($anio as $an)
                    <li class="list-marcas">
                        <a href="?marca={{ strtolower($an->marca) }}&rango={{ $an->anio }}&precio=<?php echo $_GET['precio']; ?>&hasta=<?php echo $_GET['hasta']; ?>">
                            {{ $an->anio }}
                        </a>({{ $an->total_anios }})
                    </li>
                @endforeach
            ...
            <div class="contenido-min-320 down-anio">
                @foreach($anio as $an)
                    <li class="list-marcas">
                        <a href="?marca={{ strtolower($an->marca) }}&rango={{ $an->anio }}&mas=<?php echo $_GET['mas']; ?>">
                            {{ $an->anio }}
                        </a>({{ $an->total_anios }})
                    </li>
                @endforeach
            ...
            @foreach($anio as $an)
                    <li class="list-marcas">
                        <a href="?marca={{ strtolower($an->marca) }}&rango={{ $an->anio }}&precio=<?php echo $_GET['precio']; ?>">
                            {{ $an->anio }}
                        </a>({{ $an->total_anios }})
                    </li>
                @endforeach
            ...
            <div class="contenido-min-320 down-anio">
                @foreach($anio as $an)
                    <li class="list-marcas">
                        <a href="?marca={{ strtolower($an->marca) }}&rango={{ $an->anio }}&0km">
                            {{ $an->anio }}
                        </a>({{ $an->total_anios }})
                    </li>
                @endforeach
        ...
        <?php }else{ ?>
            ...
            @foreach($anio as $an)
                <li class="list-marcas">
                    <a href="?marca={{ strtolower($an->marca) }}&rango={{ $an->anio }}">
                        {{ $an->anio }}
                    </a>({{ $an->total_anios }})
                </li>
            @endforeach
            ...
            <?php } ?>
            <?php if (isset($_GET['marca']) && isset($_GET['mas'])){ ?>
            ...
            <div class="contenido-min-320 down-precio">
                ...
                <li class="list-marcas"><a href="?marca=<?php echo $_GET['marca']; ?>&rango=<?php echo $_GET['rango']; ?>&mas=200000">Más de $500.000 </a>({{ $precio_mas_quinientos_mil }})</li>
            </div>
            <?php }elseif(isset($_GET['marca']) && isset($_GET['0km'])){ ?>
            <p class="title-nav btn-min-320 btn-min-precio">Rango de precios</p>
            <div class="contenido-min-320 down-precio">
                <li class="list-marcas"><a href="?marca=<?php echo $_GET['marca']; ?>&precio=200000&0km">Hasta $200.000 </a>({{ $precio_doscientos_mil }})</li>
                <li class="list-marcas"><a href="?marca=<?php echo $_GET['marca']; ?>&precio=200000&hasta=500000&0km">$200.000 a $500.000 </a>({{ $precio_quinientos_mil }})</li>
                <li class="list-marcas"><a href="?marca=<?php echo $_GET['marca']; ?>&mas=500000&0km">Más de $500.000 </a>({{ $precio_mas_quinientos_mil }})</li>
            </div>
            ...
            <div class="contenido-min-320 down-precio">
                ...
                <li class="list-marcas"><a href="?precio=200000&hasta=500000">$500.000 a $500.000 </a>({{ $precio_quinientos_mil }})</li>
                <li class="list-marcas"><a href="?mas=500000">Más de $200.000 </a>({{ $precio_mas_quinientos_mil }})</li>
            </div>
            <?php } ?>
            ...
            <?php if (isset($_GET['marca']) && isset($_GET['precio']) && isset($_GET['0km'])){ ?>

            <?php }elseif (isset($_GET['marca']) && isset($_GET['precio'])){ ?>
                <p class="title-nav btn-min-320 btn-min-estado">Estado</p>
                <div class="contenido-min-320 down-estado">
                    <li class="list-marcas"><a href="{{ url('selected') }}?marca=<?php echo $_GET['marca']; ?>&precio=<?php echo $_GET['precio']; ?>&0km">Nuevo </a>({{ $nuevos }})</li>
                    <li class="list-marcas"><a href="{{ url('selected') }}?marca=<?php echo $_GET['marca']; ?>&precio=<?php echo $_GET['precio']; ?>&usados">Usado </a>({{ $usados }})</li>
                </div>
            <?php }elseif (isset($_GET['marca']) && isset($_GET['0km'])){ ?>
